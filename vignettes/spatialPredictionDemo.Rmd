...
![Image to predict](figRend/lcaiImage-1.png){width=60%}
...
![Resulting classification](figRend/lcaiSpatPrediction-1.png){width=60%}
...
![Resulting class estimated probabilities](figRend/lcaiSpatProbs-1.png){width=60%}
