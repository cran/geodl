...
![Topo chips examples](figRend/topoDLChips-1.png){width=60%}

![Topo mask chips examples](figRend/topoDLChips-2.png){width=60%}
...
![Training chips mini-batch](figRend/topoDLBatch-1.png){width=60%}

![Training masks mini-batch](figRend/topoDLBatch-2.png){width=60%}
...
![Validation chips mini-batch](figRend/topoDLBatch-3.png){width=60%}

![Validation masks mini-batch](figRend/topoDLBatch-4.png){width=60%}
...
![Loss graph](figRend/topoDLLoss-1.png){width=60%}
...
![F1-score graph](figRend/topoDLF1-1.png){width=60%}
...
![Recall graph](figRend/topoDLRecall-1.png){width=60%}
...
![Precision graph](figRend/topoDLPrec-1.png){width=60%}
...
![Chips to predict](figRend/topoDLBatchPreds-1.png){width=60%}

![Reference masks](figRend/topoDLBatchPreds-2.png){width=60%}

![Predictions](figRend/topoDLBatchPreds-3.png){width=60%}
...
Mine 0.9871 0.9631    0.9448       0.991 0.9941  0.9539
```
